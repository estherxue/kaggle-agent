...
> **Superseded — do not edit this file.** Harness retrospectives are now per-competition,
> so that concurrent sessions working on different competitions cannot collide on one path
> (this file was overwritten once already):
>
> - [`competitions/playground-series-s6e6/HARNESS.md`](competitions/playground-series-s6e6/HARNESS.md)
> - [`competitions/neurogolf-2026/HARNESS.md`](competitions/neurogolf-2026/HARNESS.md)
> - MSTA: see [`competitions/multi-step-tool-attacks/README.md`](competitions/multi-step-tool-attacks/README.md)
>
> Kept temporarily for reference; slated for removal.
